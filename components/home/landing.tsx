...
export default function Landing() {
  ...
  return (
    <div className="w-full bg-[#fcfcfd]">
      ...
      {/* Founder spotlight (spec-driven) */}
      <section className="mx-auto my-6 w-full max-w-[1440px] px-4">
        <div className="relative mx-auto w-full rounded-3xl md:rounded-[32px] border border-[#EAECF0] bg-white">
          {/* Dashed wrapper */}
          <div className="box-border mx-auto max-w-[1248px] border-x border-dashed border-[#F2F4F7] px-3 py-14 md:px-6 md:py-24">
            <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center gap-4 md:flex-row md:items-center md:justify-end">
              {/* Image */}
              <div
